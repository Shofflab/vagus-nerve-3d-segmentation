...
class nnUNetTrainer(object):
    ...
    def initialize(self):
        if not self.was_initialized:
            ...
            # add model to logger
            # wandb.watch(self.network, log="all", criterion=self.loss, log_freq=1)
        else:
            raise RuntimeError(
    ...
    def on_train_start(self):
        ...
        wandb.init(
            project="nnUNet",
            config={
                "train_config": self.configuration_manager.configuration,
    ...
    def on_train_epoch_start(self):
        ...
        # wandb logging of lr
        wandb.log(
            {"lr": self.optimizer.param_groups[0]["lr"], "epoch": self.current_epoch}
        )
    ...
    def on_train_epoch_end(self, train_outputs: List[dict]):
        ...
        # wandb logging
        wandb.log({"train/loss": loss_here, "epoch": self.current_epoch})
    ...
    def on_epoch_end(self):
        ...
        wandb.log(
            {
                "val/loss": self.logger.my_fantastic_logging["val_losses"][-1],
                "val/mean_dice": self.logger.my_fantastic_logging["mean_fg_dice"][-1],
                "epoch_time_s": self.logger.my_fantastic_logging[
